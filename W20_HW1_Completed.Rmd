...
mass <- mass * 2.0     #163.2
age  <- age + 20        #41
mass_index <- mass/age #3.98048780487805
```
#
...
num_logical <- c(1, 2, 3, TRUE) # class = numerical
char_logical <- c("a", "b", "c", TRUE) # class = character
tricky <- c(1, 2, 3, "4") # class = character 
# How do you explain the result for tricky? Tricky may be a categorical variable that uses a number for identification. 
```
class(num_char)
...
# Question 3
```{r}
study_semesters <- c("Winter2015", "Fall2015", "Winter2016", "Fall2016", "Winter2017", "Fall2017", "Winter2018", "Fall2018", "Winter2019", "Fall2019", "Winter2020") # Build a vector of the study semesters (Winter2015  through Winter2020): 
supplements_consumed <- c("HiMaize", "inulin", "arabinoxylan", "BRMPS", "BRMPS+psyllium", "psyllium", "corn_starch", "banana_starch", "LOODAAT_potato_starch", "oat", "rice")# Build a vector of the supplements consumed (see powerpoint slides): 
class(study_semesters)
class(supplements_consumed)
# What type are each of these? character, character
```

# Question 4
```{r}
age <- c(17, 18, 19, 20, 21)# Build a vector of the typical age of college students:
class(age)
...
class(pH_2)
mean_pH_1 <- round(mean(pH_1), digits=2)
mean_pH_2 <- round(mean(pH_2), digits=2)
mean_pH_1 == mean_pH_2
```
-----
end